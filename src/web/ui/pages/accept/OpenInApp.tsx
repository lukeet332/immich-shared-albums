/** web/ui/pages/accept/OpenInApp.tsx — the open-in-app handover once the album has filled. See ../../../http-router.md. */
import { useEffect, useState } from 'preact/hooks';
import { albumCount, deepLink } from './api.ts';

// Enables after SYNC_WAIT_LIMIT_MS regardless — a slow sync must not strand someone here.

...
| `leave.ts`    | `leaveAlbum` — the full reverse of a join: purges every stub, the mirror album, the mapping and its ledger. A full local asset referenced by another mapping's `seen` row is retained.                                                                                                                                                                                                                                                                  |
